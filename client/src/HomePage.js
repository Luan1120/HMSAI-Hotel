    ...
    <div className="home-root">
      ...
      <section className="home-banner">
        ...
        <div className="home-banner-content">
          ...
          <button className="btn-primary home-banner-btn" onClick={() => setShowRoomsOverlay(true)}>ĐẶT PHÒNG NGAY</button>
        </div>
        {/* Chatbot Icon */}
      ...
      {openAdminBookings && (
        ...
        >
          ...
          >
            <div style={{ background: '#fff', borderRadius: 12, padding: 8 }}>
              <AdminBookings isModal onClose={() => setOpenAdminBookings(false)} />
            </div>
          </div>
        </div>
      )}
...
function GridMenu({ onOpenHistory, onOpenReviews, onOpenServices, onOpenAdminUsers, onOpenAdminServices, onOpenAdminRooms, onOpenAdminBookings, onOpenCheckInOut, onOpenCustomerSupport, onOpenAdminReports, onOpenAdminFeedback, onOpenAdminAmenities }) {
